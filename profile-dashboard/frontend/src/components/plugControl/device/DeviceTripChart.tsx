...
const DeviceTripChart = (props: Props): React.ReactElement => {
  const selectedDeviceGb = useSelector(
    (state: StoreState) => state.device.selectedDeviceGb
  );
